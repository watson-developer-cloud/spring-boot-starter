...
/**
 * The Class WatsonAutoConfigTest.
 */
...
public class WatsonAutoConfigTest {
  ...
  /** The Constant environmentVariables. */
  @ClassRule
  ...
  static {
    String vcapServices = "{\"language_translator\":[{" + "\"credentials\": {" + "\"url\":\"" + url + "\","
        + "\"username\":\"" + username + "\"," + "\"password\":\"" + password + "\"" + "}," + "\"plan\": \"free\""
        + "}]}";
  ...
  /**
   * Watson bean config from environment.
   */
  @Test
